...
use App\Models\Threedrenders\Menu;
...
class MenuController extends Controller {
	...
	public function getIndex( Request $request ,$id = null  )
	{
		...
		return view('threedrenders.menu.index',$this->data);	
	}
	...
	function postSaveorder( Request $request, $id =0)
	{
		...
		if ($validator->passes()) {
			...
			return redirect('threedrenders/menu')
	...
	function postSave( Request $request, $id =0)
	{
		...
		if ($validator->passes()) {
			...
			return redirect('threedrenders/menu?pos='.$pos)
				->with('message', 'Data Has Been Save Successfull')->with('status','success');
	...
	public function getDestroy(Request $request,$id)
	{
		...
		return redirect('threedrenders/menu?pos='.$request->input('pos'))
	...
	{
		return view('threedrenders.menu.icons');

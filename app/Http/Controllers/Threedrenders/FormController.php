...
class FormController extends Controller {
   	...
   	public function index( Request $request )
	{
        ...
        return view('threedrenders.form.index',$this->data);
	}
    ...
    public function show( Request $request , $task )
    {
        ...
        {
            default:
                return view('threedrenders.form.form',$this->data);
                break;
            case 'field':
                ...
                return view('threedrenders.form.field',$this->data);
                break;

            case 'remove':
                $id = $request->input('id');
                \DB::table('tb_forms')->where('formID',$id)->delete();
                return redirect('threedrenders/form')->with(['status'=>'success','message'=>'Form has been deleted !']);
                break;    
            ...
            case 'update':
                ...
                if($id =='')
                {
                    $rows = Threedrenders::getTableField('tb_forms');
                    $row = array();
                ...
                return view('threedrenders.form.manage',$this->data);
                break;    
            case 'preview':
                $id = $request->input('id');

...
class TablesController extends Controller 
{
   	...
   	public function index()
	{
		...
		return view('threedrenders.tables.index',$this->data);
	}   
    ...
    public function getTableconfig( $table = null )
    {
        ...
        $this->data['action'] = ($table ==null ? 'threedrenders/tables/tables/'.$table : 'threedrenders/tables/tableinfo/'.$table ) ;
        return view('threedrenders.tables.config',$this->data);
    }   
    ...
    public function postTableremove(Request $request)
    {
        ...
        if(!is_null($request->input('id')) && count($request->input('id')) >=1 )
        {
            ...
            return redirect('threedrenders/tables')->with('message', 'Table(s) has been deleted')->with('status','success');  
        } 
        return redirect('threedrenders/tables')->with('message','error','No Table(s) deleted !')->with('status','error');  
    ...
    public function getTablefieldedit( $table )
    {
        ...
        return view('threedrenders.tables.field',$this->data);
    }
    ...
    public function getMysqleditor()
    {
        ...
        return view('threedrenders.tables.editor');
    }   

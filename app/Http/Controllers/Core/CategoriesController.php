...
class CategoriesController extends Controller {
	...
	{		
		...
		$this->data = array(
			'pageTitle'	=> 	'Category',
			'pageNote'	=>  'Article Post Categories',
			'pageModule'=> 'core/categories',
	...
	function create( Request $request ) 
	{
		...
		$this->data['row'] = Threedrenders::getColumnTable( 'tb_categories'); 
		$this->data['id'] = '';
		...
		switch ($task)
		{
			...
			default:	
				...
				{			
					...
					$res = Threedrenders::updateDataRow( 'tb_categories' ,'cid' , $data , $id  );
	...
	public function destroy( $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			$res = Threedrenders::deleteDataRow( 'tb_categories' ,'cid' , $request->input('ids') );

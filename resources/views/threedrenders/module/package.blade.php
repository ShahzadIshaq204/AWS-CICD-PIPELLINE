...
<div class="page-header"><h2> Module Packager <small> Create Package Installer </small> </h2></div>
  ...
  <div class="panel-default panel">
    ...
    <ul class="parsley-error-list">
     ...
     {!! Form::open(array('url'=>'threedrenders/module/dopackage', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
     <div class="row">
          <div class="col-md-6">
              <div class="header" >
          ...
          <div class="col-md-6">
            <div class="header">
              <h3> What's this ?</h3>
                ...
                You can backup current module and install the modules to other application based Threedrenders builder - Edition Laravel </p>
                </p> 

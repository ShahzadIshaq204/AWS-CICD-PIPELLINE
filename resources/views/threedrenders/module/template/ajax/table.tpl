...
<div class="card">
	<div class="card-body">
		{!! (isset($search_map) ? $search_map : '') !!}
		 ...
		 <?php echo Form::open(array('url'=>'{class}', 'class'=>'form-horizontal' ,'id' =>'ThreedrendersTable'  ,'data-parsley-validate'=>'' )) ;?>
...
@if($setting['inline'] =='true') @include('threedrenders.module.utility.inlinegrid') @endif
@include('threedrenders.module.template.ajax.javascript')

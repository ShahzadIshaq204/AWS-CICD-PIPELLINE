...
<div class="page-header"><h2>  {{ $pageTitle }} <small>Configuration</small> </h2></div>
    ...
    @include('threedrenders.module.tab',array('active'=>'subform'))

<ul class="nav nav-tabs" style="margin-bottom:10px;">
    <li class="nav-item" ><a class="nav-link " href="{{ URL::to('threedrenders/module/form/'.$module_name)}}">Form Configuration </a></li>
    <li class="nav-item" ><a class="nav-link active" href="{{ URL::to('threedrenders/module/subform/'.$module_name)}}">Sub Form </a></li>
  <li class="nav-item"><a class="nav-link" href="{{ URL::to('threedrenders/module/formdesign/'.$module_name)}}">Form Layout</a></li>
    ...
    {!! Form::open(array('url'=>'threedrenders/module/savesubform/'.$module_name, 'class'=>'form-horizontal  ','id'=>'fSubf')) !!}
        ...
        <div class="col-md-8">
          ...
          <a href="{{ url('threedrenders/module/subformremove/'.$module_name) }}" class="btn btn-danger"><i class="icon-cancel-circle2 "></i> Remove </a>
          @endif
         </div> 
        </div> 
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ThreedrendersHelpers::sjForm('fSubf'); ?>

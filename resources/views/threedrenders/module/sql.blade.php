...
<div class="page-header"><h2>  {{ $pageTitle }} <small>Configuration</small> </h2></div>
          ...
          @include('threedrenders.module.tab',array('active'=>'sql','type'=>  $type ))

         
          {!! Form::open(array('url'=>'threedrenders/module/savesql/'.$module_name, 'class'=>'form-vertical  ' ,'id'=>'SQL' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ThreedrendersHelpers::sjForm('SQL'); ?>

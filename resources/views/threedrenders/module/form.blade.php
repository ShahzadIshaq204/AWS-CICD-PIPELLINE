...
<div class="page-header"><h2>  {{ $pageTitle }} <small>Configuration</small> </h2></div>
 ...
 @include('threedrenders.module.tab',array('active'=>'form','type'=>  $type ))

<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li class="nav-item" ><a class="nav-link active" href="{{ URL::to('threedrenders/module/form/'.$module_name)}}">Form Configuration </a></li>
  	<li class="nav-item" ><a class="nav-link" href="{{ URL::to('threedrenders/module/subform/'.$module_name)}}">Sub Form </a></li>
	<li class="nav-item"><a class="nav-link" href="{{ URL::to('threedrenders/module/formdesign/'.$module_name)}}">Form Layout</a></li>
 ...
 {!! Form::open(array('url'=>'threedrenders/module/saveform/'.$module_name, 'class'=>'form-horizontal ','id'=>'fForm')) !!}
 <div class="table-responsive">
		...
		<thead class="no-border">
          ...
          <tr>
			...
			onclick="ThreedrendersModal('{{ URL::to('threedrenders/module/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}','Edit Field : <?php echo $rows['field'];?>')">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ThreedrendersHelpers::sjForm('fForm'); ?>

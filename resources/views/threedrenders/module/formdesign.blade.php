...
<div class="page-header"><h2>  {{ $pageTitle }} <small>Configuration</small> </h2></div>
		...
		@include('threedrenders.module.tab',array('active'=>'form','type'=> 'addon'))
<ul class="nav nav-tabs" style="margin-bottom:10px;">
    <li class="nav-item" ><a class="nav-link " href="{{ url('threedrenders/module/form/'.$module_name)}}">Form Configuration </a></li>
    <li class="nav-item" ><a class="nav-link " href="{{ url('threedrenders/module/subform/'.$module_name)}}">Sub Form </a></li>
  <li class="nav-item"><a class="nav-link active" href="{{ url('threedrenders/module/formdesign/'.$module_name)}}">Form Layout</a></li>
 ...
 {!! Form::open(array('url'=>'threedrenders/module/formdesign/'.$module_name,'id'=>'doReorder', 'class'=>'form-vertical ','parsley-validate'=>'','novalidate'=>' ')) !!}
	...
	<div class="form-group">
		...
		<div class="radio-group">
			...
			<?php if($display == 'horizontal') echo 'checked';?>
			  /> <label for="c-horizontal"> Normal </label>	

...
<div class="toolbar-nav" >   
				...
				<a href="{{ url('threedrenders/form/update')}}" class="btn btn-sm  linkConfig tips ajaxCallback" title="New Table "><i class="fa fa-plus"></i> Create Form  </a>
            	...
            	<div class="row">
	            	...
	            	<div class="col-md-2">
						...
						@foreach($forms as $form)
							<li><a href="{{ url('threedrenders/form/update?id='.$form->formID) }}" class="ajaxCallback"> {{ $form->name }}</a> </li>
						@endforeach

...
@endif
 ...
 {!! Form::open(array('url'=>'threedrenders/form', 'class'=>'form-vertical','files' => true , 'parsley-validate'=>'','novalidate'=>' ' ,'id'=>'formField')) !!}
			...
			<td>
				<div class="input-group">
					<div class="input-group-btn ">
						<a href="{{ url('threedrenders/form/field')}}" class="btn btn-sm btn-default" onclick="ThreedrendersModal(this.href,'Field Configuration'); return false;"> <i class="fa fa-question-circle"></i></a>
					</div>	
...
@if($row->formID !='')
<a href="{{ url('threedrenders/form/preview?id='.$row->formID) }}" class="btn btn-success btn-sm" onclick="ThreedrendersModal(this.href,'Form Preview'); return false;"> Preview Form </a>

<a href="{{ url('threedrenders/form/remove?id='.$row->formID) }}" class="btn btn-danger btn-sm remove"> Delete This Form </a>
@endif

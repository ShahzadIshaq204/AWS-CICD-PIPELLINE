...
<div class="card">
	<div class="card-body">	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'threedrenders/rac?return='.$return, 'class'=>'form-horizontal form-material validated','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
		 <div class="row">
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
					...
					<button type="button" onclick="location.href='{{ URL::to('threedrenders/rac?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ __('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#apiuser").jCombo("{!! url('threedrenders/rac/comboselect?filter=tb_users:id:email') !!}",
		{  selected_value : '{{ $row["apiuser"] }}' });
		
		$("#modules").jCombo("{!! url('threedrenders/rac/comboselect?filter=tb_module:module_name:module_title&limit=WHERE:module_type:!=:core') !!}",

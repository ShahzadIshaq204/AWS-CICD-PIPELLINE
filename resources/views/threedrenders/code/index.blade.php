			...
			<p class="text-center text-danger"></i>Becarefful !! Do with your own Risk  </p>		  
	 		...
	 		<div class="row">
	 			...
	 			<div class="col-md-9">
	 				...
	 				{!! Form::open(array('url'=>'threedrenders/code/save', 'class'=>'form-horizontal','id'=>'FormCode' )) !!}
...
<script type="text/javascript" src="{{ asset('threedrenders5/js/plugins/ace/src/ace.js') }}"></script>
<script type="text/javascript">
    $(document).ready( function() {
        ...
        $('#container_id').fileTree({
            root: '/',
            script: '{{ url("threedrenders/code/source")}}',
            expandSpeed: 1000,
            collapseSpeed: 1000,
            multiFolder: false
        }, function(file) {
        	$('.ajaxLoading').show();	
        	$.get( "{{ url('threedrenders/code/edit/')}}",{ path:file}, function( data ) {

...
<section class="page-header ">
	<h3> Threedrenders NET <small> Connection to Main Threedrenders Server </small></h3>
	<p> Official Threedrenders Repositories </p>
</section>
...
function page( page ) {
	$('.ajaxLoading').show();
	$.get('{{ url("threedrenders/server/load?page=" ) }}'+page,function( callback ) {
		$('#items').html(callback)
		$('.ajaxLoading').hide();
	})	

...
<div class="authen-update available" style="display: none; background: none; padding: 20px;" >
		 {!! Form::open(array('url'=>'threedrenders/server', 'class'=>'form-horizontal ','files' => true , 'parsley-validate'=>'','novalidate'=>' ' ,'id'=>'doUpdate')) !!}
...
$(function(){
	$('.autoupdate').on('click',function(){
		$('.ajaxLoading').show();
		$.get('{{ url("threedrenders/server/version?check") }}',function( callback ) {

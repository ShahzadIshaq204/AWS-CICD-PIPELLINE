	...
	<div class="col-md-8 text-right"> 	
		...
		<div class="btn-group">
			...
			<div class="btn-group">
				...
				@endif
				@if($access['is_add'] ==1)
					<li class="nav-item"><a class="nav-link" href="{{ url($pageModule .'/import?return='.$return) }}" onclick="ThreedrendersModal(this.href, 'Import CSV'); return false;"> Import CSV</a></li>
				...
				@endif	
		         ...
		         @if($access['is_remove'] ==1)
					 <li class="nav-item"><a class="nav-link" href="javascript://ajax"  onclick="ThreedrendersDelete();" class="tips" title="{{ __('core.btn_remove') }}">
	...
	<div class="tab-content" style="margin-top: 0; padding: 0">
		  <div class="tab-pane active" id="info" style="padding: 0;">
			...
			<div class="table-responsive">
 			{!! Form::open(array('url'=>'cms/posts?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'ThreedrendersTable' )) !!}

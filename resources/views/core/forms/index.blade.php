	...
	<div class="card-body">
		...
		<div class="toolbar-nav">
			...
			<div class="row">
				<div class="col-md-8"> 	
					...
					<div class="btn-group">
						...
						@endif
						@if($access['is_add'] ==1)
							<li><a href="{{ url($pageModule .'/import?return='.$return) }}" onclick="ThreedrendersModal(this.href, 'Import CSV'); return false;"><i class="fa fa-cloud-upload"></i> Import CSV</a></li>
						...
						@endif	
				         ...
				         @if($access['is_remove'] ==1)
							 <li><a href="javascript://ajax"  onclick="ThreedrendersDelete();" class="tips" title="{{ __('core.btn_remove') }}"><i class="fa fa-trash-o"></i>
			...
			<div class="table-responsive" style="padding-bottom: 70px;">
 			{!! Form::open(array('url'=>'core/forms?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'ThreedrendersTable' )) !!}
							...
							<td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									@if($access['is_remove'] ==1)
										 <li><a href="javascript://ajax"  onclick="ThreedrendersDelete();" class="tips" title="{{ __('core.btn_remove') }}">
										Remove Selected </a></li>
									@endif 
								  </ul>
								</div>

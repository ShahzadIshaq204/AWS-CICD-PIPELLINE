...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="box-header-tools pull-left" >
			...
			<a class="btn btn-xs btn-warning tips btn-circle" title="Documentation" href="{{ url('core/forms/docs') }}" onclick="ThreedrendersModal(this.href,'Documentation'); return false;"><i class="fa fa-book"></i></a>
		</div>
		<div class="box-header-tools pull-right " >
			@if(Session::get('gid') ==1)
				<a href="{{ URL::to('core/threedrenders/module/config/'.$pageModule) }}" class="tips btn btn-xs btn-success btn-circle" title=" {{ Lang::get('core.btn_config') }}" ><i class="fa  fa-ellipsis-v"></i></a>
			@endif 			
		</div> 

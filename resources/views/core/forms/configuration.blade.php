...
<button type="button" onclick="ThreedrendersModal('{{ url("core/forms/input/".$row->formID) }}','New Input')" class="btn  btn-success btn-sm" ><i class="fa fa-plus"></i> New Input </button>

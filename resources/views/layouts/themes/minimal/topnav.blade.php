            ...
            <div class="navbar-header">
                ...
                <div class="top-left-part">
                    ...
                    <span class="hidden-xs">
                         ...
                         @if(file_exists(public_path().'/assets/plugins/images/'.$threedrendersconfig['cnf_logo']) && $threedrendersconfig['cnf_logo'] !='')
                        <img src="{{ asset('assets/plugins/images/'.$threedrendersconfig['cnf_logo'])}}" alt="{{ $threedrendersconfig['cnf_appname'] }}"  />
                        @else
                        <img src="{{ asset('assets/plugins/images/logo.png')}}" alt="{{ $threedrendersconfig['cnf_appname'] }}"  />
                        @endif 
                    </span> 
                ...
                <ul class="nav navbar-top-links navbar-left">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="javascript:void(0);"> <i class="mdi mdi-bell-outline"></i>
                    ...
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="javascript:void(0);"><span class="hidden-xs">Control Panel </span> <i class="icon-options-vertical"></i></a>
                        <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
                             @if(Auth::user()->group_id == 1 )
                            <li class="col-sm-3">
                                <ul>
                                    <li class="dropdown-header"> Control Panel </li>
                                     <li><a href="{{ url('threedrenders/config')}}"><i class="icon-screen-desktop"></i> {{ Lang::get('core.tab_siteinfo') }}</a> </li>
                                     <li><a href="{{ url('threedrenders/config/email')}}"><i class="icon-link"></i> {{ Lang::get('core.tab_email') }}</a> </li>
                                     <li><a href="{{ url('threedrenders/config/security')}}"><i class="icon-lock"></i> {{ Lang::get('core.tab_loginsecurity') }}</a> </li>
                                     <li><a href="{{ url('threedrenders/config/translation')}}"><i class="icon-map"></i> {{ Lang::get('core.tab_translation') }}</a> </li>
                                     <li> <a href="{{ url('threedrenders/config/clearlog')}}" class="clearCache"><i class="icon-trash"></i> Clear Log & Caches </a> </li>
                           ...
                           @if(Auth::user()->group_id == 1 or Auth::user()->group_id == 2 )
                            ...
                            <li class="col-sm-3">
                                <ul>
                                    ...
                                    <li><a href="{{ url('threedrenders/module')}}"><i class="icon-fire"></i> Module {{ Lang::get('core.m_codebuilder') }}</a>  </li>
                                    <li><a href="{{ url('threedrenders/menu')}}"><i class="icon-menu"></i> {{ Lang::get('core.m_menu') }}</a> </li>
                                    <li><a href="{{ url('threedrenders/tables')}}"><i class="fa fa-database"></i> {{ Lang::get('core.m_database') }} </a> </li>
                                    <li> <a href="{{ url('threedrenders/code')}}"><i class="icon-note"></i> {{ Lang::get('core.m_sourceeditor') }}</a>  </li>
                                    <li><a href="{{ url('core/forms')}}"><i class="icon-list"></i> {{ Lang::get('core.m_formbuilder') }}</a> </li>
                                    <li ><a href="{{ url('threedrenders/rac')}}"><i class="icon-shuffle"></i> RestAPI Generator </a> </li>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown tasks-menu">
                      ...
                      foreach(SiteHelpers::langOption() as $lang):
                        if($lang['folder'] == session('lang') or $lang['folder'] == $threedrendersconfig['cnf_lang']) {
                          $flag = $lang['folder'];
                          $langname = $lang['name']; 
                        }
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0);">  {!! SiteHelpers::avatar( 36 ) !!}<b class="hidden-xs">{{ Session::get('fid')}}</b><span class="caret"></span> </a>

            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ url('dashboard')}}">
                        <!-- Logo icon -->
                        <b>
                            @if(file_exists(public_path().'/uploads/images/'.config('threedrenders')['cnf_logo']) && config('threedrenders')['cnf_logo'] !='')
                              <img src="{{ asset('uploads/images/'.config('threedrenders')['cnf_logo'])}}" alt="{{ config('threedrenders')['cnf_appname'] }}" width="40" />
                            @else
                        ...
                        <span class="dark-logo" style=" font-weight: 500; padding-left: 10px;">
                            {{ config('threedrenders.cnf_appname') }}
                        </span> 
                    </a>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-message"></i>
                        ...
                        @if($threedrendersconfig['cnf_multilang'] ==1)
                         <li class="nav-item dropdown  hidden-xs-down">
                          ...
                          endforeach;?>
                          <a class="nav-link dropdown-toggle waves-effect waves-dark" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="flag-lang" src="{{ asset('assets/plugins/images/flags/'.$flag.'.png') }}" width="16" height="16" alt="lang" /> </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated ">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="{{ url('threedrenders/tables')}}"><i class="ti-view-list"></i> {{ Lang::get('core.m_database') }} </a> </li>
                                    ...
                                    <li><a href="{{ url('threedrenders/server/repository')}}"><i class="icon-share"></i>  Repositories </a>  </li>
                                      <li role="separator" class="divider"></li>
                                      <li> <a href="{{ url('threedrenders/server')}}" onclick="ThreedrendersModal(this.href, 'About Threedrenders'); return false "><i class="icon-info"></i> About Threedrenders  </a> </li>

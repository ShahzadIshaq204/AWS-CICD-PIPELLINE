...
function ThreedrendersModalLarge( url , title)
{
	$('#threedrenders-modal-lg #threedrenders-modal-content').html(' ....Loading content , please wait ...');
	$('#threedrenders-modal-lg  .modal-title').html(title);
	$('#threedrenders-modal-lg  #threedrenders-modal-content').load(url,function(){
	});
	$('#threedrenders-modal-lg').modal('show');
}
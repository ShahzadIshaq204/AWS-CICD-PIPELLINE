        ...
        (h.prototype = {
            ...
            (i.prototype = {
                init: function () {
                    ...
                    if (b.options.spot_circle)
                        if ((b.obj_parent.append('<div id="spot-' + b.id + '" class="ndd-spot"></div>'), (b.obj_spot = b.obj_parent.find("#spot-" + b.id)), b.options.style > 4)) {
                            ...
                            b.obj_spot.append('<div class="ndd-marker-container ndd-marker-style-' + b.options.style + '"><img src="https://stagin.piktar.tech/public/frontend/stagintheme/img/icon_loc_0' + c + '.png"></div>');
                ...
                show: function () {
					...
					if(a.options.show_popup==0) return;
                    a.is_visible ||

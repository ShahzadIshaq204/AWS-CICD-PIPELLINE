!(function (r) {
    ...
    var a = {
        ...
        onepageNavLinks: () => {
            r('.onepage .navbar ul.navbar-nav a[href="javascript:void(0);"]').on("click", function (e) {
                e.preventDefault();
            });
        },
        anchorSmoothScroll: () => {
            r(function () {
                ...
                setTimeout(function () {
                    ...
                    r('a.scroll[href*="#"]:not([href="javascript:void(0);"])').on("click", function () {
        ...
        owlCarousel: () => {
            r(".basic-slider").each(function () {
                var e = r(this);
                e.owlCarousel({ items: 1, nav: e.data("nav"), navText: ["uil uil-angle-left", "uil uil-angle-right"], dots: !0, dotsEach: !0, autoHeight: !0, loop: !0, margin: e.data("margin") });
            }),
        ...
        contactForm: () => {
            window.addEventListener(
                ...
                function () {
                        ...
                        if(document.getElementById('ThreeDRendersForm')!=null){
                            var ThreeDRendersForm = document.getElementById('ThreeDRendersForm');
                            var formData = new FormData(ThreeDRendersForm);
                        }else{
                           // var ThreeDRendersForm = document.getElementById('ThreeDRendersForm');
                        ...
                        a.addEventListener(
                            ...
                            function (e) {
                                ...
                                (e.preventDefault(),
                                    ...
                                    formData = new FormData(ThreeDRendersForm),
                                    r.ajax({
                                        type: "POST",
                                        url: r(this).attr("action"),
                                        data: formData,
                                        async: false,
                                        cache: false,
                                        contentType: false,
                                        ...
                                        success: function (e) {
                                            ...
                                            var a = "alert-" + e.type,
                                                t = e.message,
                                                e = '<div id="formAlert-'+e.type+'" class="alert ' + a + ' alert-dismissible fade show"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>' + t + "</div>";
                                            a && t && r("#ThreeDRendersFormTop").find(".messages").html(e) ;


                                          //  window.setTimeout(function () {
                                                goToByScroll("ThreeDRendersFormTop", true);
                                           // }, 300);
...
function ApiGetData(url, method, data){
